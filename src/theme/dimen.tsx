 ...
 * @param {object} classComponentThis This Screen's class component this variable.
...
const listenOrientationChange = ({
  ...
  classComponentThis?: React.Component;
  setStateHook?: React.Dispatch<React.SetStateAction<any>>;
}): void => {
  Dimensions.addEventListener('change', (newDimensions: ScaledSize) => {
    ...
    if (classComponentThis !== undefined && setStateHook === undefined) {
      classComponentThis.setState(orientation);
    } else if (setStateHook !== undefined && classComponentThis === undefined) {
